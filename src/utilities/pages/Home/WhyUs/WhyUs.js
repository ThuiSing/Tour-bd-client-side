...
const WhyUs = () => {
  return (
    <div className="whyUs py-14 mt-12">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-medium ">Why Us ?</h2>
        <h2 className="text-4xl font-semibold text-secondary w-1/3 mx-auto mt-2">
          Why You Are Travel With Tourx
        </h2>
      </div>
      <div className="container mx-auto grid grid-cols-4 gap-5">
        <div className="bg-primary text-primary text-center py-8 rounded">
          ...
          <h3 className="text-3xl font-semibold">100% Trusted Travel Agency</h3>
        </div>
        <div className="bg-primary text-primary text-center py-8 rounded">
          <i className="fas fa-globe-asia text-8xl mb-5"></i>
          <h3 className="text-3xl font-semibold">1500+ Worldwide Our Guide</h3>
        </div>
        <div className="bg-primary text-primary text-center py-8 rounded">
